...
hl.bind("SUPER + W",          hl.dsp.focus({ workspace = "name:W" }))
...
hl.bind("SUPER + A",          hl.dsp.focus({ workspace = "name:A" }))
hl.bind("SUPER + D",          hl.dsp.focus({ workspace = "name:D" }))
hl.bind("SUPER + F",          hl.dsp.focus({ workspace = "name:F" }))
...
hl.bind("SUPER + SHIFT + B",  hl.dsp.window.move({ workspace = "name:B" }))
hl.bind("SUPER + SHIFT + W",  hl.dsp.window.move({ workspace = "name:W" }))
hl.bind("SUPER + SHIFT + U",  hl.dsp.window.move({ workspace = "name:U" }))
hl.bind("SUPER + SHIFT + I",  hl.dsp.window.move({ workspace = "name:I" }))
hl.bind("SUPER + SHIFT + O",  hl.dsp.window.move({ workspace = "name:O" }))
hl.bind("SUPER + SHIFT + P",  hl.dsp.window.move({ workspace = "name:P" }))
hl.bind("SUPER + SHIFT + A",  hl.dsp.window.move({ workspace = "name:A" }))
hl.bind("SUPER + SHIFT + D",  hl.dsp.window.move({ workspace = "name:D" }))
hl.bind("SUPER + SHIFT + F",  hl.dsp.window.move({ workspace = "name:F" }))
